...
SWEP.Purpose				= "Kek"
SWEP.PrintName				= "Combine Prison Guard [SUIT]"
...
if CLIENT then
SWEP.WepSelectIcon 		= surface.GetTextureID("vgui/entities/csb_combine_prisonguard_icon.vtf")
SWEP.Slot				= 5
SWEP.SlotPos			= 5
SWEP.IconLetter			= "O"
	...
	elseif self:GetNW2Bool("CSB_SecondaryAbility") == true and (self.Owner:GetNW2Bool("CSB_PlayingAnim") != true or (self.Owner:GetNW2Bool("CSB_PlayingAnim") == true and self.Owner:GetNW2Int("CSB_Gslot") != 6)) then
		...
		if SERVER then
			...
			timer.Simple(0.8, function()
				...
				self.cower:Spawn()
				self.cower:Activate()
				self.cower:SetNW2Bool("CSB_SpawnedEQ", true)
