...
SWEP.PrintName				= "Citizen Male [SUIT]"
SWEP.AbilityPrimaryDesc		= "None"
SWEP.AbilitySecondaryDesc	= "None"

if CLIENT then
SWEP.WepSelectIcon 			= surface.GetTextureID("vgui/entities/csb_citizen_icon.vtf")
SWEP.Slot					= 5
SWEP.SlotPos				= 5
SWEP.IconLetter				= "O"
...
sound.Add( {
	name = "CSBPlySound.Rebel.Grenade",
	channel = CHAN_AUTO,
	volume = 1,
	level = 75,
	pitch = 100,
	sound = {"vo/npc/male01/headsup01.wav","vo/npc/male01/headsup02.wav"}, 
} )

sound.Add( {
	name = "CSBPlySound.Rebel.Ammo",
	channel = CHAN_AUTO,
	volume = 1,
	level = 75,
	pitch = 100,
	sound = {"vo/npc/male01/ammo03.wav","vo/npc/male01/ammo04.wav", "vo/npc/male01/ammo05.wav"}, 
} )

sound.Add( {
	name = "CSBPlySound.Rebel.Melee",
	channel = CHAN_AUTO,
	volume = 1,
	level = 75,
	pitch = {90, 105},
	sound = { "vo/npc/male01/pain04.wav", "vo/npc/male01/pain05.wav", "vo/npc/male01/pain09.wav", "vo/npc/male01/pain07.wav" }
} )

SWEP.PlyModel 					= "models/Humans/Group01/Male_01.mdl"
...
SWEP.PlyMeleeTable = {
['meleesound']	= "CSBPlySound.Rebel.Melee",
['meleedmg']	= 20,
['meleerang']	= 64,
...
sound.Add( {
	name = "CSBPlySound.Rebel.KickVL",
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = 75,
	pitch = 100,
	sound = {"vo/npc/male01/letsgo01.wav", "vo/npc/male01/letsgo02.wav", "vo/npc/male01/myleg01.wav", "vo/npc/male01/myleg02.wav"},
} )

SWEP.DoorKickTable = {
['dksound']		= "CSBPlySound.Rebel.Melee",
['dkvl']		= "CSBPlySound.Rebel.KickVL", -- good for voice lines
['dkvld']		= 0,
['dkrang']		= 32,
...
['gsound']		= "CSBPlySound.Rebel.Grenade",
...
SWEP.WorldModelSpawnPose = {
	...
	['ValveBiped.Bip01_R_Hand'] = { ang = Angle( 90, 0, 0 ) },
    ['ValveBiped.Bip01_L_Hand'] = { ang = Angle( -90, 0, 0 ) },
...
local RandomModels = {
{"models/Humans/Group01/Male_01.mdl", "0200000", 1, Color(0,65,85)},
{"models/Humans/Group01/male_02.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/male_03.mdl", "0200000", 1, Color(0,65,85)},
{"models/Humans/Group01/Male_04.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/Male_05.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/male_06.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/male_07.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/male_08.mdl", "0200000", 0, Color(0,65,85)},
{"models/Humans/Group01/male_09.mdl", "0200000", 0, Color(0,65,85)}
}
...
SWEP.CSBPlyNPCCommand1 = {
	sound = {{"vo/npc/male01/help01.wav", "vo/npc/male01/headsup01.wav", "vo/npc/male01/headsup02.wav", "vo/npc/male01/overthere01.wav", "vo/npc/male01/overthere02.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
...
SWEP.CSBPlyNPCCommand2 = {
	sound = {{"vo/npc/male01/letsgo01.wav", "vo/npc/male01/letsgo02.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBPlyNPCCommand3 = {
	sound = {{"vo/npc/male01/leadtheway01.wav", "vo/npc/male01/leadtheway02.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBPlyNPCCommand4 = {
	sound = {{"vo/npc/male01/squad_away01.wav", "vo/npc/male01/squad_away02.wav", "vo/npc/male01/squad_away03.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBPlyNPCCommand5 = {
	sound = {{"npc/citizen/stayhere.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBPlyNPCCommand6 = {
	sound = {{"npc/citizen/holdspot01.wav", "npc/citizen/holdspot02.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBPlyNPCCommand7 = {
	sound = {{"vo/npc/male01/watchout.wav", "vo/npc/male01/strider_run.wav", "vo/npc/male01/runforyourlife01.wav", "vo/npc/male01/runforyourlife02.wav", "vo/npc/male01/runforyourlife03.wav"}},
	duration = {0},
	channel = CHAN_AUTO,
	volume = VOL_NORM,
	level = SNDLVL_TALKING,
...
SWEP.CSBTransAct = {
	...
	['pistol'] = {
	[ ACT_MP_STAND_IDLE ] 						    = {ACT_IDLE, "idle_ar2_aim"};
	...
	[ ACT_MP_RUN ] 						   		    = {ACT_RUN, "run_all_panicked"};
	[ ACT_MP_CROUCH_IDLE ] 				    	    = {"crouchIdle_panicked4"};
