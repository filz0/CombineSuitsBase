...
SWEP.Purpose				= "Kek"
SWEP.PrintName				= "Combine Shotgunner [SUIT]"
SWEP.AbilityPrimaryDesc		= "[Stimshot]: A powerful Combine chem, increases speed, mobility and heals a bit."
SWEP.AbilitySecondaryDesc	= "[Proxy Nade]: A throwable contact grenade, remotely detonable."

if CLIENT then
SWEP.WepSelectIcon 		= surface.GetTextureID("vgui/entities/csb_combine_soldier_s_icon.vtf")
SWEP.Slot				= 5
SWEP.SlotPos			= 5
SWEP.IconLetter			= "O"
...
SWEP.PlyHandsModel 				= "models/weapons/combine_arms/juonovom/hl2 vanilla/c_arms_combine_shotgunner.mdl"
SWEP.PlyHandsMaterial 			= ""
SWEP.NPCAnims					= true
